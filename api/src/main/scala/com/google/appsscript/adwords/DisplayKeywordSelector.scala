...
trait DisplayKeywordSelector {
   ...
   */
  def forDateRange(dateRange: String): DisplayKeywordSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): DisplayKeywordSelector = ???
  /**  Fetches the requested display keywords and returns an iterator. */
  def get: DisplayKeywordIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_displaykeywordselector.html#withCondition_1">DisplayKeywordSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_displaykeywordselector.html#forDateRange_1">DisplayKeywordSelector.forDateRange(String)</a> or <a href="adwordsapp_displaykeywordselector.html#forDateRange_2">DisplayKeywordSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): DisplayKeywordSelector = ???
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Display Keyword attributes</i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Status</td> 
   ...
   *    <td>AdGroupStatus</td> 
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("AdGroupStatus = ENABLED")</code>. Use to fetch display keywords from only <code>ENABLED</code> ad groups.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>CampaignName</td> 
   *    <td>String</td> 
   ...
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("CampaignStatus = ENABLED")</code>. Use to fetch display keywords from only <code>ENABLED</code> campaigns.</td> 
   *   </tr> 
   *  </tbody>
   * </table>
   *  
   ...
   */
  def withCondition(condition: String): DisplayKeywordSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Seq[Long]]): DisplayKeywordSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): DisplayKeywordSelector = ???
}