...
trait AdCustomizerItemSelector extends Selector[AdCustomizerItemSelector] {
   ...
   */
  def orderBy(orderBy: String): AdCustomizerItemSelector = js.native
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i> Ad customizer item attributes </i></strong>
   *     </center></td>
   *   </tr>
   *   <tr>
   *    <td>DevicePreferenceType</td>
   *    <td>Enumeration: <code>MOBILE</code>, <code>ALL</code></td>
   *    <td><code>withCondition("DevicePreferenceType = MOBILE")</code>. Use to fetch only mobile-preferred ad customizer items.</td>
   *   </tr>
   *  </tbody>
   * </table>
