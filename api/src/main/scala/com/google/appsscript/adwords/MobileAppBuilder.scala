...
trait MobileAppBuilder {
  ...
  def withAppId(appId: String): MobileAppBuilder = ???
  /**
   ...
   */
  def withSchedules(schedules: Seq[ExtensionSchedule]): MobileAppBuilder = ???
  /**
