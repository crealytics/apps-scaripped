 ...
 *  }</pre>
 */
trait AdGroupSitelinkSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): AdGroupSitelinkSelector = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): AdGroupSitelinkSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): AdGroupSitelinkSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): AdGroupSitelinkSelector = js.native
}