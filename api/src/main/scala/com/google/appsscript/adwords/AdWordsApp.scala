...
trait AdWordsApp extends js.Object {
   ...
   * <a href="adwordsapp_adcustomizersourcebuilder.html#build_0">AdCustomizerSourceBuilder.build()</a>
   ...
   *   </tr>
   *   <tr>
   *    <td>resolveGeoNames</td>
   *    <td><code>boolean</code></td>
   *    <td> Whether or not to convert Geo CriteriaIds (e.g. CountryCriteriaId and CityCriteriaId) into names (e.g. 'United States' and 'San Francisco'). Set to <code>true</code> if you want names. Set to <code>false</code> if you want numerical IDs. Defaults to <code>true</code>. </td>
   *   </tr>
   *  </tbody>
   * </table>
   */
  def report(query: String, optArgs: AnyRef): Report = js.native
