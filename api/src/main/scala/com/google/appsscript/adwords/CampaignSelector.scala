 ...
 *  }</pre>
 */
trait CampaignSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): CampaignSelector = js.native
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): CampaignSelector = js.native
  /**  Fetches the requested campaigns and returns an iterator. */
  def get(): CampaignIterator = js.native
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_campaignselector.html#withCondition_1">CampaignSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_campaignselector.html#forDateRange_1">CampaignSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignselector.html#forDateRange_2">CampaignSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): CampaignSelector = js.native
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Campaign attributes</i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Status</td> 
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_campaignselector.html#forDateRange_1">CampaignSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignselector.html#forDateRange_2">CampaignSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): CampaignSelector = js.native
  /**
   *  Restricts this selector to return only campaigns with the given campaign IDs. 
   * <pre class="prettyprint">
   *  var campaignIds = [12345, 23456, 34567];
   *  selector = selector.withIds(campaignIds);</pre>
   *  
   ...
   *  will only get the campaign with ID 
   * <code>34567</code>
   ...
   */
  def withLimit(limit: Int): CampaignSelector = js.native
}
