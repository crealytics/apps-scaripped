...
trait AdGroupSelector {
   ...
   */
  def forDateRange(dateRange: String): AdGroupSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): AdGroupSelector = ???
  /**  Fetches the requested ad groups and returns an iterator. */
  def get: AdGroupIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_adgroupselector.html#withCondition_1">AdGroupSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_adgroupselector.html#forDateRange_1">AdGroupSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupselector.html#forDateRange_2">AdGroupSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AdGroupSelector = ???
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Ad group attributes</i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Status</td> 
   ...
   *    <td>Name</td> 
   *    <td>String</td> 
   *    <td><code>withCondition("Name CONTAINS_IGNORE_CASE 'shoes'")</code></td> 
   *   </tr> 
   *   <tr> 
   *    <td>CampaignName</td> 
   *    <td>String</td> 
   ...
   *    <td>KeywordMaxCpc</td> 
   *    <td>Double</td> 
   *    <td><code>withCondition("KeywordMaxCpc &gt; 10.0")</code>. The value is in the currency of the account.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>CampaignStatus</td> 
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("CampaignStatus = ENABLED")</code>. Use to fetch ad groups from only <code>ENABLED</code> campaigns.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>LabelNames</td> 
   *    <td>StringSet</td> 
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_adgroupselector.html#forDateRange_1">AdGroupSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupselector.html#forDateRange_2">AdGroupSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): AdGroupSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): AdGroupSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): AdGroupSelector = ???
}