 ...
 */
trait CampaignBidding {
  /**
   *  Returns the flexible bidding strategy of the campaign. If this campaign has an anonymous bidding strategy, or no bidding strategy, 
   * <code>null</code>
   *  is returned.
   */
  def getStrategy: BiddingStrategy = ???
  /**
   *  Returns the bidding strategy source of this campaign. The bidding strategy source indicates where the bidding strategy came from: 
   * <code>'CAMPAIGN'</code>
   * , 
   * <code>'ADGROUP'</code>
   * , or 
  ...
  /**
   *  Returns the bidding strategy type of this campaign. This may either be an anonymous bidding strategy, or the the 
   * <code>type</code>
  ...
  /**
   *  Sets the bidding strategy of this campaign to the provided flexible bidding strategy. 
