...
trait DisplayKeywordBidding extends js.Object {
  ...
  /**  Returns the max CPM bid for this display keyword. */
  ...
  /**
   *  Sets the max CPM bid for this display keyword.
   * <p>Please note that although this method will effectively set the max CPM bid for this display keyword, the change may have no effect on actual bidding if this display keyword has a <a href="adwordsapp_biddingstrategy.html">BiddingStrategy</a> which does not involve max CPM bids.</p>
   *
   * <p>Returns nothing.</p>
   *
   */
