...
trait AdGroup {
   ...
   *  
   */
  def createKeyword(keywordText: String): Unit = ???
  /**
   ...
   *  
   */
  def createKeyword(keywordText: String, maxCpc: Double): Unit = ???
  /**
   ...
   *  
   */
  def createKeyword(keywordText: String, maxCpc: Double, destinationUrl: String): Unit = ???
  /**
   ...
   *  
   */
  def createTextAd(headline: String, description1: String, description2: String, displayUrl: String, destinationUrl: String): Unit = ???
  /**
   ...
   *  
   */
  def createTextAd(headline: String, description1: String, description2: String, displayUrl: String, destinationUrl: String, optArgs: AnyRef): Unit = ???
  /**
   ...
   * .
   */
  def extensions: AdGroupExtensions = ???
  ...
  def newKeywordBuilder: KeywordBuilder = ???
  /**  Returns a new ad builder associated with this ad group. */
  def newTextAdBuilder: AdBuilder = ???
  /**
   *  Pauses the ad group. 
   * <p>Returns nothing.</p>
   *  
   ...
   *  
   */
  def setKeywordMaxCpc(keywordMaxCpc: Double): Unit = ???
  /**
