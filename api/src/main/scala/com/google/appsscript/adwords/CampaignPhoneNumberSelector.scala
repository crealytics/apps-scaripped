 ...
 *  }</pre>
 */
trait CampaignPhoneNumberSelector extends Selector[CampaignPhoneNumberSelector] {
  /**
   ...
   */
  override def withCondition(condition: String): CampaignPhoneNumberSelector = js.native
  /**
