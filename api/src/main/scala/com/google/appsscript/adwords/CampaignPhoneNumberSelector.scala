...
trait CampaignPhoneNumberSelector {
   ...
   */
  def forDateRange(dateRange: String): CampaignPhoneNumberSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): CampaignPhoneNumberSelector = ???
  /**  Fetches the requested campaign-level phone numbers and returns an iterator. */
  def get: CampaignPhoneNumberIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_campaignphonenumberselector.html#withCondition_1">CampaignPhoneNumberSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_campaignphonenumberselector.html#forDateRange_1">CampaignPhoneNumberSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignphonenumberselector.html#forDateRange_2">CampaignPhoneNumberSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): CampaignPhoneNumberSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_campaignphonenumberselector.html#forDateRange_1">CampaignPhoneNumberSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignphonenumberselector.html#forDateRange_2">CampaignPhoneNumberSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): CampaignPhoneNumberSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): CampaignPhoneNumberSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): CampaignPhoneNumberSelector = ???
}