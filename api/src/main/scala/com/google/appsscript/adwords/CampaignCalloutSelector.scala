 ...
 *  }</pre>
 */
trait CampaignCalloutSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): CampaignCalloutSelector = js.native
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): CampaignCalloutSelector = js.native
  /**  Fetches the requested campaign-level callouts and returns an iterator. */
  def get(): CampaignCalloutIterator = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): CampaignCalloutSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): CampaignCalloutSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): CampaignCalloutSelector = js.native
}