...
trait AdGroupBidding extends js.Object {
   ...
   * <p>Please note that although this method will effectively set the CPM bid for this ad group, the change may have no effect on actual bidding if this ad group has a <a href="adwordsapp_biddingstrategy.html">BiddingStrategy</a> which does not involve CPM bids.</p>
   * <p>See <a href="https://support.google.com/adwords/answer/6310"> Cost-per-thousand impressions (CPM)</a> for more information.</p>
   * <p>Returns nothing.</p>
   */
