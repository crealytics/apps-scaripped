 ...
 *  }</pre>
 */
trait SitelinkSelector extends Selector[SitelinkSelector] {
  /**
   ...
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): SitelinkSelector = js.native
  /** Fetches the requested sitelinks and returns an iterator. */
  def get(): SitelinkIterator = js.native
  /**
   ...
   * </ul>
   * <p>See <a href="adwordsapp_sitelinkselector.html#withCondition_1">SitelinkSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   ...
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_sitelinkselector.html#forDateRange_1">SitelinkSelector.forDateRange(String)</a> or <a href="adwordsapp_sitelinkselector.html#forDateRange_2">SitelinkSelector.forDateRange(Object, Object)</a>.</p>
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): SitelinkSelector = js.native
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Sitelink attributes</i></strong>
   *     </center></td>
   *   </tr>
   *   <tr>
   *    <td>DevicePreferenceType</td>
   *    <td>Enumeration: <code>MOBILE</code>, <code>ALL</code></td>
   *    <td><code>withCondition("DevicePreferenceType = MOBILE")</code>. Use to fetch only mobile-preferred sitelinks.</td>
   *   </tr>
   *  </tbody>
   * </table>
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_sitelinkselector.html#forDateRange_1">SitelinkSelector.forDateRange(String)</a> or <a href="adwordsapp_sitelinkselector.html#forDateRange_2">SitelinkSelector.forDateRange(Object, Object)</a>. </p>
   */
  override def withCondition(condition: String): SitelinkSelector = js.native
  /**
   * Restricts this selector to return only sitelinks with the given sitelink IDs.
   * <pre class="prettyprint">
   *  var sitelinkIds = [12345, 23456, 34567];
   *  selector = selector.withIds(sitelinkIds);</pre>
   ...
   * <pre class="prettyprint">
   *  AdWordsApp.extensions().sitelinks()
   *     .withIds([12345, 23456, 34567])
   *     .withIds([34567, 45678, 56789]);</pre>
   * will only get the sitelink with ID
   * <code>34567</code>
