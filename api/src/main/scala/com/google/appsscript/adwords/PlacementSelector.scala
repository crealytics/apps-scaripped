...
trait PlacementSelector {
   ...
   */
  def forDateRange(dateRange: String): PlacementSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): PlacementSelector = ???
  /**  Fetches the requested placements and returns an iterator. */
  def get: PlacementIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_placementselector.html#withCondition_1">PlacementSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_placementselector.html#forDateRange_1">PlacementSelector.forDateRange(String)</a> or <a href="adwordsapp_placementselector.html#forDateRange_2">PlacementSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): PlacementSelector = ???
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Keyword attributes</i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Status</td> 
   ...
   *    <td>PlacementUrl</td> 
   *    <td>String</td> 
   *    <td><code>withCondition("PlacementUrl STARTS_WITH 'test'")</code></td> 
   *   </tr> 
   *   <tr> 
   *    <td>MaxCpc</td> 
   *    <td>Double</td> 
   *    <td><code>withCondition("MaxCpc &gt; 0.50")</code>. The value is in the currency of the account.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>QualityScore</td> 
   *    <td>Integer</td> 
   *    <td><code>withCondition("QualityScore &gt;= 6")</code></td> 
   *   </tr> 
   *   <tr> 
   *    <td>FirstPageCpc</td> 
   *    <td>Double</td> 
   *    <td><code>withCondition("FirstPageCpc &lt; 1.00")</code>. The value is in the currency of the account.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>TopOfPageCpc</td> 
   *    <td>Double</td> 
   *    <td><code>withCondition("TopOfPageCpc &lt; 3.00")</code>. The value is in the currency of the account.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>AdGroupName</td> 
   *    <td>String</td> 
   ...
   *    <td>AdGroupStatus</td> 
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("AdGroupStatus = ENABLED")</code>. Use to fetch placements from only <code>ENABLED</code> ad groups.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>CampaignName</td> 
   *    <td>String</td> 
   ...
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("CampaignStatus = ENABLED")</code>. Use to fetch placements from only <code>ENABLED</code> campaigns.</td> 
   *   </tr> 
   *  </tbody>
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_placementselector.html#forDateRange_1">PlacementSelector.forDateRange(String)</a> or <a href="adwordsapp_placementselector.html#forDateRange_2">PlacementSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): PlacementSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Seq[Long]]): PlacementSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): PlacementSelector = ???
}