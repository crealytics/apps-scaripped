 ...
 */
trait ShoppingAdGroupBidding {
  /**
   *  Clears the bidding strategy for this shopping ad group. This will allow this ad group to inherit its bidding strategy from the campaign level. 
   * <p>Returns nothing.</p>
   *  
   */
  ...
  def getCpc: Double = ???
  /**
   *  Returns the flexible bidding strategy of the shopping ad group. If this shopping ad group has an anonymous bidding strategy, or no bidding strategy, 
   * <code>null</code>
   *  is returned.
   */
  def getStrategy: BiddingStrategy = ???
  /**
   *  Returns the bidding strategy source of this shopping ad group. The bidding strategy source indicates where the bidding strategy came from: 
   * <code>'CAMPAIGN'</code>
   * , 
   * <code>'ADGROUP'</code>
   * , or 
  ...
  /**
   *  Returns the bidding strategy type of this shopping ad group. This may either be an anonymous bidding strategy, or the the 
   * <code>type</code>
   ...
   * <p>Please note that although this method will effectively set the max CPC bid for this shopping ad group, the change may have no effect on actual bidding if this shopping ad group has a <a href="adwordsapp_biddingstrategy.html">BiddingStrategy</a> which does not involve max CPC bids.</p>
   *  
   * <p>Returns nothing.</p>
   *  
   */
  ...
  /**
   *  Sets the bidding strategy of this shopping ad group to the provided flexible bidding strategy. 
   ...
   *  
   */
  def setStrategy(biddingStrategy: BiddingStrategy): Unit = ???
}