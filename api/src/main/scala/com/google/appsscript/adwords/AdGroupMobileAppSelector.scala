...
/**
 * 
 *  Fetches ad group-level mobile apps. Supports filtering and sorting. 
 * <p>Typical usage:</p>
 *  
 * <pre class="prettyprint">
 *  var adGroupMobileAppSelector = adGroup.extensions()
 *      .mobileApps()
 *      .withCondition("Impressions &gt; 100")
 *      .forDateRange("LAST_MONTH")
 *      .orderBy("Clicks DESC");
 * 
 *  var adGroupMobileAppIterator = adGroupMobileAppSelector.get();
 *  while (adGroupMobileAppIterator.hasNext()) {
 *    var adGroupMobileApp = adGroupMobileAppIterator.next();
 *  }</pre>
 */
trait AdGroupMobileAppSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): AdGroupMobileAppSelector = js.native
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): AdGroupMobileAppSelector = js.native
  /**  Fetches the requested ad group-level mobile apps and returns an iterator. */
  def get(): AdGroupMobileAppIterator = js.native
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_adgroupmobileappselector.html#withCondition_1">AdGroupMobileAppSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_adgroupmobileappselector.html#forDateRange_1">AdGroupMobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupmobileappselector.html#forDateRange_2">AdGroupMobileAppSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AdGroupMobileAppSelector = js.native
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_adgroupmobileappselector.html#forDateRange_1">AdGroupMobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupmobileappselector.html#forDateRange_2">AdGroupMobileAppSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): AdGroupMobileAppSelector = js.native
  /**
   *  Restricts this selector to return only ad group-level mobile apps with the given ad group-level mobile app IDs. 
   * <pre class="prettyprint">
   *  var adGroupMobileAppIds = [12345, 23456, 34567];
   *  selector = selector.withIds(adGroupMobileAppIds);</pre>
   *  
   ...
   * <pre class="prettyprint">
   *  adGroup.extensions().mobileApps()
   *     .withIds([12345, 23456, 34567])
   *     .withIds([34567, 45678, 56789]);</pre>
   *  will only get the ad group-level mobile app with ID 
   * <code>34567</code>
   * , since it would be the only ad group-level mobile app that satisfies both ID conditions.
   * <p></p>
   */
  def withIds(ids: js.Array[Long]): AdGroupMobileAppSelector = js.native
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): AdGroupMobileAppSelector = js.native
}
