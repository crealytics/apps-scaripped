 ...
 *  }</pre>
 */
trait AdGroupMobileAppSelector extends Selector[AdGroupMobileAppSelector] {
  /**
   ...
   */
  override def withCondition(condition: String): AdGroupMobileAppSelector = js.native
  /**
