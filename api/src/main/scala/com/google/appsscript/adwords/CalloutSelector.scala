 ...
 *  }</pre>
 */
trait CalloutSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): CalloutSelector = js.native
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_calloutselector.html#withCondition_1">CalloutSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_calloutselector.html#forDateRange_1">CalloutSelector.forDateRange(String)</a> or <a href="adwordsapp_calloutselector.html#forDateRange_2">CalloutSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): CalloutSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): CalloutSelector = js.native
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): CalloutSelector = js.native
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): CalloutSelector = js.native
}
