...
trait KeywordSelector {
   ...
   */
  def forDateRange(dateRange: String): KeywordSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): KeywordSelector = ???
  /**  Fetches the requested keywords and returns an iterator. */
  def get: KeywordIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_keywordselector.html#withCondition_1">KeywordSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_keywordselector.html#forDateRange_1">KeywordSelector.forDateRange(String)</a> or <a href="adwordsapp_keywordselector.html#forDateRange_2">KeywordSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): KeywordSelector = ???
  /**
   ...
   *    <td>String</td> 
   *    <td><code>withCondition("DestinationUrl CONTAINS 'example.com'")</code></td> 
   *   </tr> 
   *   <tr> 
   *    <td>QualityScore</td> 
   *    <td>Integer</td> 
   ...
   *    <td>AdGroupStatus</td> 
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("AdGroupStatus = ENABLED")</code>. Use to fetch keywords from only <code>ENABLED</code> ad groups.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>CampaignName</td> 
   *    <td>String</td> 
   ...
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("CampaignStatus = ENABLED")</code>. Use to fetch keywords from only <code>ENABLED</code> campaigns.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>LabelNames</td> 
   *    <td>StringSet</td> 
   ...
   */
  def withCondition(condition: String): KeywordSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Seq[Long]]): KeywordSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): KeywordSelector = ???
}