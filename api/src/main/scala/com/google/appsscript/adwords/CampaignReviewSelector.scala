...
trait CampaignReviewSelector {
   ...
   */
  def forDateRange(dateRange: String): CampaignReviewSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): CampaignReviewSelector = ???
  /**  Fetches the requested campaign-level reviews and returns an iterator. */
  def get: CampaignReviewIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_campaignreviewselector.html#withCondition_1">CampaignReviewSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_campaignreviewselector.html#forDateRange_1">CampaignReviewSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignreviewselector.html#forDateRange_2">CampaignReviewSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): CampaignReviewSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_campaignreviewselector.html#forDateRange_1">CampaignReviewSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignreviewselector.html#forDateRange_2">CampaignReviewSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): CampaignReviewSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): CampaignReviewSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): CampaignReviewSelector = ???
}