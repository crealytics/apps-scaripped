...
/**
 * 
 *  Fetches ad group-level reviews. Supports filtering and sorting. 
 * <p>Typical usage:</p>
 *  
 * <pre class="prettyprint">
 *  var adGroupReviewSelector = adGroup.extensions()
 *      .reviews()
 *      .withCondition("Impressions &gt; 100")
 *      .forDateRange("LAST_MONTH")
 *      .orderBy("Clicks DESC");
 * 
 *  var adGroupReviewIterator = adGroupReviewSelector.get();
 *  while (adGroupReviewIterator.hasNext()) {
 *    var adGroupReview = adGroupReviewIterator.next();
 *  }</pre>
 */
trait AdGroupReviewSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): AdGroupReviewSelector = js.native
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): AdGroupReviewSelector = js.native
  /**  Fetches the requested ad group-level reviews and returns an iterator. */
  def get(): AdGroupReviewIterator = js.native
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_adgroupreviewselector.html#withCondition_1">AdGroupReviewSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_adgroupreviewselector.html#forDateRange_1">AdGroupReviewSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupreviewselector.html#forDateRange_2">AdGroupReviewSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AdGroupReviewSelector = js.native
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_adgroupreviewselector.html#forDateRange_1">AdGroupReviewSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupreviewselector.html#forDateRange_2">AdGroupReviewSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): AdGroupReviewSelector = js.native
  /**
   *  Restricts this selector to return only ad group-level reviews with the given ad group-level review IDs. 
   * <pre class="prettyprint">
   *  var adGroupReviewIds = [12345, 23456, 34567];
   *  selector = selector.withIds(adGroupReviewIds);</pre>
   *  
   ...
   * <pre class="prettyprint">
   *  adGroup.extensions().reviews()
   *     .withIds([12345, 23456, 34567])
   *     .withIds([34567, 45678, 56789]);</pre>
   *  will only get the ad group-level review with ID 
   * <code>34567</code>
   ...
   */
  def withLimit(limit: Int): AdGroupReviewSelector = js.native
}
