...
trait BudgetSelector {
   ...
   */
  def forDateRange(dateRange: String): BudgetSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): BudgetSelector = ???
  /**  Fetches the requested budgets and returns an iterator. */
  def get: BudgetIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_budgetselector.html#withCondition_1">BudgetSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_budgetselector.html#forDateRange_1">BudgetSelector.forDateRange(String)</a> or <a href="adwordsapp_budgetselector.html#forDateRange_2">BudgetSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): BudgetSelector = ???
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Budget attributes</i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Name</td> 
   ...
   *    <td>Amount</td> 
   *    <td>Double</td> 
   *    <td><code>withCondition("Amount &gt; 50")</code></td> 
   *   </tr> 
   *   <tr> 
   *    <td>IsBudgetExplicitlyShared</td> 
   *    <td>Boolean</td> 
   *    <td><code>withCondition("IsBudgetExplicitlyShared = true")</code></td> 
   *   </tr> 
   *   <tr> 
   *    <td>ReferenceCount</td> 
   *    <td>Integer</td> 
   *    <td><code>withCondition("ReferenceCount &gt; 1")</code></td> 
   *   </tr> 
   *  </tbody>
   * </table>
   *  
   ...
   */
  def withCondition(condition: String): BudgetSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): BudgetSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): BudgetSelector = ???
}