...
trait ExcludedDisplayKeywordSelector {
  ...
  def get: ExcludedDisplayKeywordIterator = ???
  /**
   ...
   */
  def orderBy(orderBy: String): ExcludedDisplayKeywordSelector = ???
  /**
   ...
   * <code>AND</code>
   * -ed together. The above example will retrieve excluded display keywords that start with the letter 'a' and are of broad match type. 
   * <p></p>
   *  
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i> Excluded display keyword attributes </i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Text</td> 
   ...
   *    <td><code>withCondition("AdGroupStatus = ENABLED")</code>. Use to fetch excluded display keywords from only <code>ENABLED</code> ad groups.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>CampaignName</td> 
   *    <td>String</td> 
   ...
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>REMOVED</code></td> 
   *    <td><code>withCondition("CampaignStatus = ENABLED")</code>. Use to fetch excluded display keywords from only <code>ENABLED</code> campaigns.</td> 
   *   </tr> 
   *  </tbody>
   * </table>
   */
  def withCondition(condition: String): ExcludedDisplayKeywordSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): ExcludedDisplayKeywordSelector = ???
}