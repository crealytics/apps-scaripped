 ...
 *  }</pre>
 */
trait ReviewSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): ReviewSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): ReviewSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): ReviewSelector = js.native
}