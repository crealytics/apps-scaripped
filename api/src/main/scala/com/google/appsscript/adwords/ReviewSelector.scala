...
trait ReviewSelector {
   ...
   */
  def forDateRange(dateRange: String): ReviewSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): ReviewSelector = ???
  /**  Fetches the requested reviews and returns an iterator. */
  def get: ReviewIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_reviewselector.html#withCondition_1">ReviewSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_reviewselector.html#forDateRange_1">ReviewSelector.forDateRange(String)</a> or <a href="adwordsapp_reviewselector.html#forDateRange_2">ReviewSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): ReviewSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_reviewselector.html#forDateRange_1">ReviewSelector.forDateRange(String)</a> or <a href="adwordsapp_reviewselector.html#forDateRange_2">ReviewSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): ReviewSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): ReviewSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): ReviewSelector = ???
}