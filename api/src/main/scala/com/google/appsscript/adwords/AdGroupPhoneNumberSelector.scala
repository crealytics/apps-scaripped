 ...
 *  }</pre>
 */
trait AdGroupPhoneNumberSelector {
  /**
   ...
   */
  def forDateRange(dateRange: String): AdGroupPhoneNumberSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): AdGroupPhoneNumberSelector = ???
  /**  Fetches the requested ad group-level phone numbers and returns an iterator. */
  def get: AdGroupPhoneNumberIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_adgroupphonenumberselector.html#withCondition_1">AdGroupPhoneNumberSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_adgroupphonenumberselector.html#forDateRange_1">AdGroupPhoneNumberSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupphonenumberselector.html#forDateRange_2">AdGroupPhoneNumberSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AdGroupPhoneNumberSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_adgroupphonenumberselector.html#forDateRange_1">AdGroupPhoneNumberSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupphonenumberselector.html#forDateRange_2">AdGroupPhoneNumberSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): AdGroupPhoneNumberSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): AdGroupPhoneNumberSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): AdGroupPhoneNumberSelector = ???
}