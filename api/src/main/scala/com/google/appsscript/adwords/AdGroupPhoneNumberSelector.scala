 ...
 *  }</pre>
 */
trait AdGroupPhoneNumberSelector extends Selector[AdGroupPhoneNumberSelector] {
  /**
   ...
   */
  override def withCondition(condition: String): AdGroupPhoneNumberSelector = js.native
  /**
