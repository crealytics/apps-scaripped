 ...
 *  }</pre>
 */
trait AdGroupPhoneNumberSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): AdGroupPhoneNumberSelector = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): AdGroupPhoneNumberSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): AdGroupPhoneNumberSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): AdGroupPhoneNumberSelector = js.native
}