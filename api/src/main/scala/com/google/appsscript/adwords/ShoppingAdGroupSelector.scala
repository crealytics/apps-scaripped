...
trait ShoppingAdGroupSelector {
   ...
   */
  def forDateRange(dateRange: String): ShoppingAdGroupSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): ShoppingAdGroupSelector = ???
  /**  Fetches the requested shopping ad groups and returns an iterator. */
  def get: ShoppingAdGroupIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_shoppingadgroupselector.html#withCondition_1">ShoppingAdGroupSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *    <td colspan="3">
   *     <center>
   *      <b><i>Shopping ad group attributes</i></b>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Status</td> 
   *    <td>Enumeration: <code>ENABLED</code>, <code>PAUSED</code>, <code>DELETED</code></td> 
   ...
   *    <td><code>withCondition("CampaignStatus = ACTIVE")</code>. Use to fetch ad groups from only <code>ACTIVE</code> campaigns.</td> 
   *   </tr> 
   *   <tr> 
   *    <td>LabelNames</td> 
   *    <td>StringSet</td> 
   ...
   */
  def withCondition(condition: String): ShoppingAdGroupSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): ShoppingAdGroupSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): ShoppingAdGroupSelector = ???
}