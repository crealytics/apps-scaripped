...
trait PhoneNumberSelector {
   ...
   */
  def forDateRange(dateRange: String): PhoneNumberSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): PhoneNumberSelector = ???
  /**  Fetches the requested phone numbers and returns an iterator. */
  def get: PhoneNumberIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_phonenumberselector.html#withCondition_1">PhoneNumberSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_phonenumberselector.html#forDateRange_1">PhoneNumberSelector.forDateRange(String)</a> or <a href="adwordsapp_phonenumberselector.html#forDateRange_2">PhoneNumberSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): PhoneNumberSelector = ???
  /**
   ...
   */
  def withCondition(condition: String): PhoneNumberSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): PhoneNumberSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): PhoneNumberSelector = ???
}