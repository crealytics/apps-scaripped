 ...
 *  }</pre>
 */
trait PhoneNumberSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): PhoneNumberSelector = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): PhoneNumberSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): PhoneNumberSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): PhoneNumberSelector = js.native
}