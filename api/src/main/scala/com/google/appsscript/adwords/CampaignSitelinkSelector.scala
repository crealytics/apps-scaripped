...
trait CampaignSitelinkSelector {
   ...
   */
  def forDateRange(dateRange: String): CampaignSitelinkSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): CampaignSitelinkSelector = ???
  /**  Fetches the requested campaign-level sitelinks and returns an iterator. */
  def get: CampaignSitelinkIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_campaignsitelinkselector.html#withCondition_1">CampaignSitelinkSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_campaignsitelinkselector.html#forDateRange_1">CampaignSitelinkSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignsitelinkselector.html#forDateRange_2">CampaignSitelinkSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): CampaignSitelinkSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_campaignsitelinkselector.html#forDateRange_1">CampaignSitelinkSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignsitelinkselector.html#forDateRange_2">CampaignSitelinkSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): CampaignSitelinkSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): CampaignSitelinkSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): CampaignSitelinkSelector = ???
}