 ...
 *  }</pre>
 */
trait CampaignSitelinkSelector extends Selector[CampaignSitelinkSelector] {
  /**
   ...
   */
  override def withCondition(condition: String): CampaignSitelinkSelector = js.native
  /**
