...
trait BulkUploads {
   ...
   *      });</pre>
   */
  def newCsvUpload(columnNames: Seq[String], optArgs: AnyRef): CsvUpload = ???
  /**
   *  Creates a 
   * <a href="adwordsapp_fileupload.html">FileUpload</a>
   *  with the given Google Sheet.
   */
  def newFileUpload(sheet: Sheet): FileUpload = ???
  /**
   *  Creates a 
   * <a href="adwordsapp_fileupload.html">FileUpload</a>
   ...
   */
  def newFileUpload(blob: Blob): FileUpload = ???
  /**
   *  Creates a 
   * <a href="adwordsapp_fileupload.html">FileUpload</a>
   ...
   *  }</pre>
   */
  def newFileUpload(file: File): FileUpload = ???
}