...
trait AdGroupCalloutSelector {
   ...
   */
  def forDateRange(dateRange: String): AdGroupCalloutSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): AdGroupCalloutSelector = ???
  /**  Fetches the requested ad group-level callouts and returns an iterator. */
  def get: AdGroupCalloutIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_adgroupcalloutselector.html#withCondition_1">AdGroupCalloutSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_adgroupcalloutselector.html#forDateRange_1">AdGroupCalloutSelector.forDateRange(String)</a> or <a href="adwordsapp_adgroupcalloutselector.html#forDateRange_2">AdGroupCalloutSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AdGroupCalloutSelector = ???
  /**
   ...
   */
  def withCondition(condition: String): AdGroupCalloutSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): AdGroupCalloutSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): AdGroupCalloutSelector = ???
}