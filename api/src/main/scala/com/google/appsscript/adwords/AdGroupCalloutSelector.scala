...
trait AdGroupCalloutSelector extends js.Object {
   ...
   */
  def forDateRange(dateRange: String): AdGroupCalloutSelector = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): AdGroupCalloutSelector = js.native
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): AdGroupCalloutSelector = js.native
  /**
