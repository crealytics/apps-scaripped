...
trait ProductGroupSelector extends js.Object {
   ...
   */
  def forDateRange(dateRange: String): ProductGroupSelector = js.native
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): ProductGroupSelector = js.native
  /**  Fetches the requested product groups and returns an iterator. */
  def get: ProductGroupIterator = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): ProductGroupSelector = js.native
  /**
