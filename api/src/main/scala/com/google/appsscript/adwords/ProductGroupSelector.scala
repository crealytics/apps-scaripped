...
/**
 * 
 *  Fetches product groups. Supports filtering and sorting. 
 * <p>Typical usage:</p>
 *  
...
trait ProductGroupSelector {
   ...
   */
  def forDateRange(dateRange: String): ProductGroupSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): ProductGroupSelector = ???
  /**  Fetches the requested product groups and returns an iterator. */
  def get: ProductGroupIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_productgroupselector.html#withCondition_1">ProductGroupSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_productgroupselector.html#forDateRange_1">ProductGroupSelector.forDateRange(String)</a> or <a href="adwordsapp_productgroupselector.html#forDateRange_2">ProductGroupSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): ProductGroupSelector = ???
  /**
   ...
   */
  def withCondition(condition: String): ProductGroupSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): ProductGroupSelector = ???
}