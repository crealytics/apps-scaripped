...
trait TargetedLocationSelector {
   ...
   */
  def forDateRange(dateRange: String): TargetedLocationSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): TargetedLocationSelector = ???
  /**  Fetches the requested targeted locations and returns an iterator. */
  def get: TargetedLocationIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_targetedlocationselector.html#withCondition_1">TargetedLocationSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_targetedlocationselector.html#forDateRange_1">TargetedLocationSelector.forDateRange(String)</a> or <a href="adwordsapp_targetedlocationselector.html#forDateRange_2">TargetedLocationSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): TargetedLocationSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_targetedlocationselector.html#forDateRange_1">TargetedLocationSelector.forDateRange(String)</a> or <a href="adwordsapp_targetedlocationselector.html#forDateRange_2">TargetedLocationSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): TargetedLocationSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Seq[Long]]): TargetedLocationSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): TargetedLocationSelector = ???
}