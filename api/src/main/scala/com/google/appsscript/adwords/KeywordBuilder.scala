...
trait KeywordBuilder {
   ...
   */
  def build: KeywordOperation = ???
  /**  Sets the bidding strategy of the new keyword to the specified value. */
  def withBiddingStrategy(biddingStrategy: BiddingStrategy): KeywordBuilder = ???
  /**
   ...
   * <p></p>
   */
  def withBiddingStrategy(biddingStrategy: String): KeywordBuilder = ???
  /**  Sets the max CPC bid of the new keyword to the specified value. */
  def withCpc(cpc: Double): KeywordBuilder = ???
  /**  Sets the max CPM bid of the new keyword to the specified value. */
  def withCpm(cpm: Double): KeywordBuilder = ???
  /**  Sets the destination URL of the keyword to the specified value. */
  def withDestinationUrl(destinationUrl: String): KeywordBuilder = ???
  /**
   ...
   * </ul>
   */
  def withText(text: String): KeywordBuilder = ???
}