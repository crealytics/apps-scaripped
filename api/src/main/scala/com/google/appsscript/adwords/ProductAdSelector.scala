...
trait ProductAdSelector {
   ...
   */
  def forDateRange(dateRange: String): ProductAdSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): ProductAdSelector = ???
  /**  Fetches the requested product ads and returns an iterator. */
  def get: ProductAdIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_productadselector.html#withCondition_1">ProductAdSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_productadselector.html#forDateRange_1">ProductAdSelector.forDateRange(String)</a> or <a href="adwordsapp_productadselector.html#forDateRange_2">ProductAdSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): ProductAdSelector = ???
  /**
   *  Adds the specified condition to the product ad selector in order to narrow down the results. 
   * <p>Multiple conditions may be added to the same product ad selector: </p>
   * <pre class="prettyprint">
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Product Ad attributes</i></strong>
   *     </center></td>
   *   </tr> 
   *   <tr> 
   *    <td>Status</td> 
   ...
   */
  def withCondition(condition: String): ProductAdSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Seq[Long]]): ProductAdSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): ProductAdSelector = ???
}