...
trait MobileAppSelector extends Selector[MobileAppSelector] {
   ...
   */
  def orderBy(orderBy: String): MobileAppSelector = js.native
  /**
   ...
   *    <td colspan="3">
   *     <center>
   *      <strong><i>Mobile app attributes</i></strong>
   *     </center></td>
   *   </tr>
   *   <tr>
   *    <td>DevicePreferenceType</td>
   *    <td>Enumeration: <code>MOBILE</code>, <code>ALL</code></td>
   *    <td><code>withCondition("DevicePreferenceType = MOBILE")</code>. Use to fetch only mobile-preferred mobile app extensions.</td>
   *   </tr>
   *  </tbody>
   * </table>
