...
trait MobileAppSelector {
   ...
   */
  def forDateRange(dateRange: String): MobileAppSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): MobileAppSelector = ???
  /**  Fetches the requested mobile apps and returns an iterator. */
  def get: MobileAppIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_mobileappselector.html#withCondition_1">MobileAppSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_mobileappselector.html#forDateRange_1">MobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_mobileappselector.html#forDateRange_2">MobileAppSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): MobileAppSelector = ???
  /**
   ...
   */
  def withCondition(condition: String): MobileAppSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): MobileAppSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): MobileAppSelector = ???
}