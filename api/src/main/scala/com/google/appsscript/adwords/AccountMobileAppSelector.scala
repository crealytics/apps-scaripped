 ...
 *  }</pre>
 */
trait AccountMobileAppSelector extends Selector[AccountMobileAppSelector] {
  /**
   ...
   * </ul>
   * <p>See <a href="adwordsapp_accountmobileappselector.html#withCondition_1">AccountMobileAppSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   ...
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_accountmobileappselector.html#forDateRange_1">AccountMobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_accountmobileappselector.html#forDateRange_2">AccountMobileAppSelector.forDateRange(Object, Object)</a>.</p>
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AccountMobileAppSelector = js.native
  /**
   ...
   *  </tbody>
   * </table>
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_accountmobileappselector.html#forDateRange_1">AccountMobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_accountmobileappselector.html#forDateRange_2">AccountMobileAppSelector.forDateRange(Object, Object)</a>. </p>
   */
  override def withCondition(condition: String): AccountMobileAppSelector = js.native
  /**
