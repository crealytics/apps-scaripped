...
trait ManagedAccountSelector extends js.Object {
   ...
   * <code>callbackFunctionName</code>
   * , is executed once. 
   ...
   * <pre class="prettyprint">
   *  <code>return JSON.stringify({value:10, list:[1,2,3,4,5,6], name: "Joe Smith"});</code></pre>
   *  
   * <p></p>
   *  
   ...
   *  
   * <p>The signature for the <code>callbackFunctionName</code> should be: </p>
   * <pre class="prettyprint">
   ...
   */
  def forDateRange(dateRange: String): ManagedAccountSelector = js.native
  /**
   ...
   *  
   * <aside class="warning">
   *  Note that managed accounts only keep stats for the most recent 90 days. Statistics from earlier than 90 days ago will all come back as 
   *  <code>0</code>.
   * </aside>
   */
