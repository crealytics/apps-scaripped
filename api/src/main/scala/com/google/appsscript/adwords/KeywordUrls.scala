...
/**
 * Provides access to keyword URLs. See
 * <a href="//support.google.com/adwords/answer/6049217">Using Upgraded URLs</a>
 * for more information.
 */
trait KeywordUrls extends js.Object with HasFinalUrl {
  /**
   * Clears the final URL of the keyword.
   * <p>Clearing final URL at the keyword level will cause the final URL of the corresponding ad to be used instead.</p>
   * <p>Please note that you should clear any tracking template or final mobile URL that is set on the keyword before clearing the final URL, as clearing final URL will fail with an error if either final mobile URL or tracking template is set on this keyword.</p>
