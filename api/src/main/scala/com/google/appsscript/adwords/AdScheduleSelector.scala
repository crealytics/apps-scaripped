...
trait AdScheduleSelector {
   ...
   */
  def forDateRange(dateRange: String): AdScheduleSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): AdScheduleSelector = ???
  /**  Fetches the requested ad schedules and returns an iterator. */
  def get: AdScheduleIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_adscheduleselector.html#withCondition_1">AdScheduleSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_adscheduleselector.html#forDateRange_1">AdScheduleSelector.forDateRange(String)</a> or <a href="adwordsapp_adscheduleselector.html#forDateRange_2">AdScheduleSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): AdScheduleSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_adscheduleselector.html#forDateRange_1">AdScheduleSelector.forDateRange(String)</a> or <a href="adwordsapp_adscheduleselector.html#forDateRange_2">AdScheduleSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): AdScheduleSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Seq[Long]]): AdScheduleSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): AdScheduleSelector = ???
}