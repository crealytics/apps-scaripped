 ...
 *  }</pre>
 */
trait AdScheduleSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): AdScheduleSelector = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): AdScheduleSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): AdScheduleSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): AdScheduleSelector = js.native
}