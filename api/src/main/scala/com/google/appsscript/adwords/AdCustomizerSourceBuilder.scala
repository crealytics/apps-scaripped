...
trait AdCustomizerSourceBuilder {
   ...
   */
  def addAttribute(name: String, `type`: String): AdCustomizerSourceBuilder = ???
  /**
   ...
   */
  def addAttributes(attributes: AnyRef): AdCustomizerSourceBuilder = ???
  /**
