...
trait PlacementBidding extends js.Object {
  /**
   * Clears the max CPC bid for this placement. This will allow this placement to inherit its bid from the ad group level.
   * <p>Please note that although this method will effectively clear the max CPC bid for this placement, the change may have no effect on actual bidding if this placement has a <a href="adwordsapp_biddingstrategy.html">BiddingStrategy</a> which does not involve max CPC bids.</p>
   * <p>Returns nothing.</p>
   */
  def clearCpc(): Unit = js.native
  /**
   * Clears the CPM bid for this placement. This will allow this placement to inherit its bid from the ad group level.
   * <p>Please note that although this method will effectively clear the CPM bid for this placement, the change may have no effect on actual bidding if this placement has a <a href="adwordsapp_biddingstrategy.html">BiddingStrategy</a> which does not involve CPM bids.</p>
  ...
  /**
   * Clears the bidding strategy for this placement. This will allow this placement to inherit its bidding strategy from the ad group level.
   * <p>Returns nothing.</p>
   */
  ...
  /**
   * Sets the bidding strategy of this placement to the specified anonymous bidding strategy.
