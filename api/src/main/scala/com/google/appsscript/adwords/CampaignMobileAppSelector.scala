 ...
 *  }</pre>
 */
trait CampaignMobileAppSelector extends js.Object {
  /**
   ...
   */
  def forDateRange(dateRange: String): CampaignMobileAppSelector = js.native
  /**
   ...
   */
  def orderBy(orderBy: String): CampaignMobileAppSelector = js.native
  /**
   ...
   */
  def withCondition(condition: String): CampaignMobileAppSelector = js.native
  /**
   ...
   */
  def withLimit(limit: Int): CampaignMobileAppSelector = js.native
}
