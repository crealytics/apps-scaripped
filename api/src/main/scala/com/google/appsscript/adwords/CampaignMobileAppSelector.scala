 ...
 *  }</pre>
 */
trait CampaignMobileAppSelector extends Selector[CampaignMobileAppSelector] {
  /**
   ...
   */
  override def withCondition(condition: String): CampaignMobileAppSelector = js.native
  /**
