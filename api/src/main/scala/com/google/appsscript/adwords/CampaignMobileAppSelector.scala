 ...
 *  }</pre>
 */
trait CampaignMobileAppSelector {
  /**
   ...
   */
  def forDateRange(dateRange: String): CampaignMobileAppSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): CampaignMobileAppSelector = ???
  /**  Fetches the requested campaign-level mobile apps and returns an iterator. */
  def get: CampaignMobileAppIterator = ???
  /**
   ...
   * </ul>
   *  
   * <p>See <a href="adwordsapp_campaignmobileappselector.html#withCondition_1">CampaignMobileAppSelector.withCondition(String)</a> for enumeration of columns that can be used.</p>
   *  
   ...
   *  
   * <p>If a stats column is used in the ordering, date range must be specified via <a href="adwordsapp_campaignmobileappselector.html#forDateRange_1">CampaignMobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignmobileappselector.html#forDateRange_2">CampaignMobileAppSelector.forDateRange(Object, Object)</a>.</p>
   *  
   * <p><code>LabelNames</code> column cannot be used for ordering.</p>
   */
  def orderBy(orderBy: String): CampaignMobileAppSelector = ???
  /**
   ...
   * </table>
   *  
   * <p>If a stats column is used in the condition, date range must be specified via <a href="adwordsapp_campaignmobileappselector.html#forDateRange_1">CampaignMobileAppSelector.forDateRange(String)</a> or <a href="adwordsapp_campaignmobileappselector.html#forDateRange_2">CampaignMobileAppSelector.forDateRange(Object, Object)</a>. </p>
   */
  def withCondition(condition: String): CampaignMobileAppSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): CampaignMobileAppSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): CampaignMobileAppSelector = ???
}