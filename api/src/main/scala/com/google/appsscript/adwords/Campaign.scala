...
trait Campaign {
   ...
   *  
   */
  def addAdSchedule(adSchedule: AnyRef): Unit = ???
  /**
   ...
   *  
   */
  def addAdSchedule(dayOfWeek: String, startHour: Int, startMinute: Int, endHour: Int, endMinute: Int, bidModifier: Double): Unit = ???
  /**
   ...
   */
  def addCallout(calloutExtension: Callout): CalloutOperation = ???
  /**
   ...
   *  
   */
  def addLocation(location: AnyRef): Unit = ???
  /**
   ...
   *  
   */
  def addLocation(locationId: Int, bidModifier: Double): Unit = ???
  /**
   ...
   */
  def addMobileApp(mobileAppExtension: MobileApp): MobileAppOperation = ???
  /**
   ...
   */
  def addPhoneNumber(phoneNumberExtension: PhoneNumber): PhoneNumberOperation = ???
  /**
   ...
   *  
   */
  def addProximity(proximity: AnyRef): Unit = ???
  /**
   ...
   *  
   */
  def addProximity(latitude: Double, longitude: Double, radius: Double, radiusUnits: String, optArgs: AnyRef): Unit = ???
  /**
   ...
   */
  def addReview(reviewExtension: Review): ReviewOperation = ???
  /**
   ...
   */
  def addSitelink(sitelinkExtension: Sitelink): SitelinkOperation = ???
   ...
   *  
   */
  def createNegativeKeyword(keywordText: String): Unit = ???
  /**
   ...
   *  
   */
  def excludeLocation(locationOrId: AnyRef): Unit = ???
  /**
   ...
   * .
   */
  def extensions: CampaignExtensions = ???
  /**
   ...
   */
  def getBiddingStrategyType: String = ???
  /**
   ...
   */
  def negativeKeywords: NegativeKeywordSelector = ???
  /**
   ...
   */
  def newAdGroupBuilder: AdGroupBuilder = ???
  /**
   *  Pauses the campaign. 
   * <p>Returns nothing.</p>
   *  
   ...
   *  
   */
  def setAdRotationType(adRotationType: String): Unit = ???
  /**
   ...
   *  
   */
  def setBudget(amount: Double): Unit = ???
  /**
