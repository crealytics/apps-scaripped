...
trait SitelinkBuilder {
  ...
  def withDescription1(description1: String): SitelinkBuilder = ???
  /**  Sets the second description line of the new sitelink description to the specified value. */
  def withDescription2(description2: String): SitelinkBuilder = ???
  /**
   ...
   */
  def withSchedules(schedules: Seq[ExtensionSchedule]): SitelinkBuilder = ???
  /**
   ...
   * </ul>
   */
  def withStartDate(date: AnyRef): SitelinkBuilder = ???
}