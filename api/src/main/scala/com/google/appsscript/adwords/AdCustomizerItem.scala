...
trait AdCustomizerItem {
   ...
   *  format.
   */
  def getAttributeValue(name: String): AnyRef = ???
  /**
   ...
   *  otherwise.
   */
  def getTargetAdGroupName: String = ???
  /**
   *  Returns the name of the target campaign, if it is set. Returns 
   * <code>null</code>
   *  otherwise.
   */
  def getTargetCampaignName: String = ???
  /**
   ...
   * </ul>
   */
  def getTargetKeywordText: String = ???
  /**
   *  Returns 
   * <code>true</code>
   ...
   *  
   */
  def setAttributeValue(name: String, value: AnyRef): Unit = ???
  /**
   ...
   *  
   */
  def setAttributeValues(attributeValues: AnyRef): Unit = ???
  /**
   ...
   *  
   */
  def setTargetAdGroup(campaignName: String, adGroupName: String): Unit = ???
  /**
   ...
   *  
   */
  def setTargetCampaign(campaignName: String): Unit = ???
  /**
   ...
   *  
   */
  def setTargetKeyword(keyword: String): Unit = ???
}