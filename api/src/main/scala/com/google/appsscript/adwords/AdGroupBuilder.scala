...
trait AdGroupBuilder {
  ...
  def withBiddingStrategy(biddingStrategy: BiddingStrategy): AdGroupBuilder = ???
  /**
   ...
   * <p></p>
   */
  def withBiddingStrategy(biddingStrategy: String): AdGroupBuilder = ???
  /**
   ...
   */
  def withCpa(cpa: Double): AdGroupBuilder = ???
  /**
   ...
   */
  def withCpc(cpc: Double): AdGroupBuilder = ???
  /**
   ...
   */
  def withCpm(cpm: Double): AdGroupBuilder = ???
  /**
   ...
   * </aside>
   */
  def withKeywordMaxCpc(keywordMaxCpc: Double): AdGroupBuilder = ???
