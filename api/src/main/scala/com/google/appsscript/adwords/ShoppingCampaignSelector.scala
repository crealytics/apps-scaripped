...
trait ShoppingCampaignSelector {
   ...
   */
  def forDateRange(dateRange: String): ShoppingCampaignSelector = ???
  /**
   ...
   * <p>Date range must be specified if the selector has conditions or ordering for a stat field. Note that only the last date range specified for the selector will take effect.</p>
   */
  def forDateRange(dateFrom: AnyRef, dateTo: AnyRef): ShoppingCampaignSelector = ???
  /**  Fetches the requested shopping campaigns and returns an iterator. */
  def get: ShoppingCampaignIterator = ???
  /**
   ...
   */
  def orderBy(orderBy: String): ShoppingCampaignSelector = ???
  /**
   ...
   */
  def withCondition(condition: String): ShoppingCampaignSelector = ???
  /**
   ...
   * <p></p>
   */
  def withIds(ids: Seq[Long]): ShoppingCampaignSelector = ???
  /**
   *  Specifies limit for the selector to use. For instance, 
   * <code>withLimit(50)</code>
   *  returns only the first 50 entities.
   */
  def withLimit(limit: Int): ShoppingCampaignSelector = ???
}