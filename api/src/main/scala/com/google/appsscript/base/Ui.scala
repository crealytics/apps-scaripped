...
trait Ui {
  ...
  def showModalDialog(userInterface: Object)(title: String): Unit = ???
  ...
  def showModelessDialog(userInterface: Object)(title: String): Unit = ???
  ...
  def showSidebar(userInterface: Object): Unit = ???
  ...
  def showDialog(userInterface: Object): Unit = ???
}