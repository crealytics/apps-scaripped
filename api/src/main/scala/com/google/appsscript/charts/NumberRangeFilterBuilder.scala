 ...
 */
trait NumberRangeFilterBuilder {
  /** Builds a control. */
  def build: Control = ???
  ...
  def setDataTable(tableBuilder: DataTableBuilder): NumberRangeFilterBuilder = ???
  /** Sets the control data table, which will be the control's underlying data model. */
  def setDataTable(table: DataTableSource): NumberRangeFilterBuilder = ???
  ...
  def setFilterColumnIndex(columnIndex: Int): NumberRangeFilterBuilder = ???
  ...
  def setMaxValue(maxValue: Int): NumberRangeFilterBuilder = ???
  ...
  def setMinValue(minValue: Int): NumberRangeFilterBuilder = ???
  ...
  def setTicks(ticks: Int): NumberRangeFilterBuilder = ???
}