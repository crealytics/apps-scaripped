 ...
 *  }
 */
trait ScatterChartBuilder {
  /** Builds the chart. */
  def build: Chart = ???
  /** Sets the background color for the chart. */
  def setBackgroundColor(cssValue: String): ScatterChartBuilder = ???
  /** Sets the colors for the lines in the chart. */
  def setColors(cssValues: Seq[String]): ScatterChartBuilder = ???
  ...
  def setDataSourceUrl(url: String): ScatterChartBuilder = ???
  ...
  def setDataTable(tableBuilder: DataTableBuilder): ScatterChartBuilder = ???
  ...
  def setDataTable(table: DataTableSource): ScatterChartBuilder = ???
  ...
  def setTitle(chartTitle: String): ScatterChartBuilder = ???
  /** Sets the text style of the chart title. */
  def setTitleTextStyle(textStyle: TextStyle): ScatterChartBuilder = ???
  ...
  def setXAxisTitle(title: String): ScatterChartBuilder = ???
  /** Sets the horizontal axis title text style. */
  def setXAxisTitleTextStyle(textStyle: TextStyle): ScatterChartBuilder = ???
  ...
  def setYAxisTitle(title: String): ScatterChartBuilder = ???
  /** Sets the vertical axis title text style. */
  def setYAxisTitleTextStyle(textStyle: TextStyle): ScatterChartBuilder = ???
}