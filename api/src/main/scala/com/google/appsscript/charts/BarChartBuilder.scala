...
trait BarChartBuilder {
  ...
  def reverseCategories: BarChartBuilder = ???
  ...
  def reverseDirection: BarChartBuilder = ???
  /** Sets the background color for the chart. */
  def setBackgroundColor(cssValue: String): BarChartBuilder = ???
  /** Sets the colors for the lines in the chart. */
  def setColors(cssValues: Seq[String]): BarChartBuilder = ???
  ...
  def setDataSourceUrl(url: String): BarChartBuilder = ???
  ...
  def setDataTable(tableBuilder: DataTableBuilder): BarChartBuilder = ???
  ...
  def setDataTable(table: DataTableSource): BarChartBuilder = ???
  ...
  def setTitle(chartTitle: String): BarChartBuilder = ???
  /** Sets the text style of the chart title. */
  def setTitleTextStyle(textStyle: TextStyle): BarChartBuilder = ???
  /** Sets the horizontal axis text style. */
  def setXAxisTextStyle(textStyle: TextStyle): BarChartBuilder = ???
  /** Adds a title to the horizontal axis. The title will be centered and will appear below the axis value labels. */
  def setXAxisTitle(title: String): BarChartBuilder = ???
  /** Sets the horizontal axis title text style. */
  def setXAxisTitleTextStyle(textStyle: TextStyle): BarChartBuilder = ???
  /** Sets the vertical axis text style. */
  def setYAxisTextStyle(textStyle: TextStyle): BarChartBuilder = ???
  /** Adds a title to the vertical axis. The title will be centered and will appear to the left of the value labels. */
  def setYAxisTitle(title: String): BarChartBuilder = ???
  /** Sets the vertical axis title text style. */
  def setYAxisTitleTextStyle(textStyle: TextStyle): BarChartBuilder = ???
  ...
  def useLogScale: BarChartBuilder = ???
}