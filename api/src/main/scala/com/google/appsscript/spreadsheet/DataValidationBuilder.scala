...
trait DataValidationBuilder {
  ...
  def requireDateAfter(date: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def requireDateBefore(date: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def requireDateBetween(start: scala.scalajs.js.Date, end: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def requireDateEqualTo(date: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def requireDateNotBetween(start: scala.scalajs.js.Date, end: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def requireDateOnOrAfter(date: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def requireDateOnOrBefore(date: scala.scalajs.js.Date): DataValidationBuilder = ???
  ...
  def withCriteria(criteria: DataValidationCriteria, args: Seq[AnyRef]): DataValidationBuilder = ???
}