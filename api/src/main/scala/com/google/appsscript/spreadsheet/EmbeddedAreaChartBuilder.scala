...
/** EmbeddedAreaChartBuilder Builder for area charts. For more details, see the Gviz documentation. */
trait EmbeddedAreaChartBuilder {
  ...
  def setColors(cssValues: Seq[String]): EmbeddedAreaChartBuilder = ???
  ...
  def setLegendTextStyle(textStyle: TextStyle): EmbeddedAreaChartBuilder = ???
  /**
   */
  ...
  def setRange(start: Number)(end: Number): EmbeddedAreaChartBuilder = ???
  ...
  def setTitleTextStyle(textStyle: TextStyle): EmbeddedAreaChartBuilder = ???
  /** Sets the horizontal axis text style. */
  def setXAxisTextStyle(textStyle: TextStyle): EmbeddedAreaChartBuilder = ???
  ...
  def setXAxisTitleTextStyle(textStyle: TextStyle): EmbeddedAreaChartBuilder = ???
  /** Sets the vertical axis text style. */
  def setYAxisTextStyle(textStyle: TextStyle): EmbeddedAreaChartBuilder = ???
  ...
  def setYAxisTitleTextStyle(textStyle: TextStyle): EmbeddedAreaChartBuilder = ???
