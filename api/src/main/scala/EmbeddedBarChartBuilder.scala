...
trait EmbeddedBarChartBuilder {
  ...
  def setColors(cssValues: Seq[String]): EmbeddedBarChartBuilder = ???
  ...
  def setTitleTextStyle(textStyle: TextStyle): EmbeddedBarChartBuilder = ???
  /** Sets the horizontal axis text style. */
  def setXAxisTextStyle(textStyle: TextStyle): EmbeddedBarChartBuilder = ???
  ...
  def setXAxisTitleTextStyle(textStyle: TextStyle): EmbeddedBarChartBuilder = ???
  /** Sets the vertical axis text style. */
  def setYAxisTextStyle(textStyle: TextStyle): EmbeddedBarChartBuilder = ???
  ...
  def setYAxisTitleTextStyle(textStyle: TextStyle): EmbeddedBarChartBuilder = ???
